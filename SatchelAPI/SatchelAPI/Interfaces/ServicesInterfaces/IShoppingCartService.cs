...
public interface IShoppingCartService
{
    ...
    public Task AddProductToShoppingCart(int productId, int userId, string sizeTypeId);
    public Task DeleteProductFromShoppingCart(int productId, int userId, int sizeTypeId);
